...
al_to=['Aspirin','Penicillin','ibuprofen','sulfa drugs','amoxicillin','ampicillin','tetracycline','Naproxen',
       'chemotherapy drugs','cetuximab','Rituximab','Abacavir','Nevirapine','Insulin','Carbamazepine','Lamotrigine',
       'Phenytoin','Atracurium','Glucagon','Alpha-glucosidase','Beta Blockers', 'ACE inhinitors']
...
def drugPred():
    ...
    if(S6En=="None"):
        ...
        al2= S6En
        diabetes = ["Glucagon","Alpha-glucosidase"]
        tension = ["Beta Blockers", "ACE inhinitors"]
        allergies = ["Alpha-glucosidase"]
        t6.delete('1.0', END)

        #if any(Allergetic_To in diabetes for Allergetic_To in allergies):
        #    diabetes1 = [d for d in diabetes if d not in allergies]
        #    for d in diabetes:
        #        if d not in allergies:
         #           t6.insert(END, "Alpha-glucosidase")
        #else:
        #    t6.insert(END, diabetes)
...
Allergetic_To =StringVar()
Allergetic_To.set(None)

# Heading
w2 = Label(root, justify=LEFT, text="Disease & medicine Prediction using Machine Learning", fg="black", bg="lavender")
w2.config(font=("Elephant", 25))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="", fg="white", bg="lavender")
...
S6Lb = Label(root,text="Allergetic to", fg="black", bg="white")
...
S6En = OptionMenu(root, Allergetic_To,*OPTIONS1)
